...
function cardBackInfo(pokeData) {
    ...
    let typesOne = document.createElement('h1')
    ...
    typesOne.textContent = pokeData.types[0].type.name
    infoDiv.appendChild(typesOne)
...
const newPokemonButton = document.querySelector('#type')
